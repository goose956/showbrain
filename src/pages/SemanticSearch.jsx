...
export default function SemanticSearch({ episodes }) {
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      {!hasTranscripts && (
        <div className="flex items-start gap-3 rounded-xl p-4 mb-6 border" style={{background:'rgb(254 243 199/0.4)', borderColor:'rgb(217 119 6/0.4)'}}>
          <span className="text-th-tx2 text-lg leading-none shrink-0">⚠</span>
          <div>
            <p className="text-th-tx1 text-sm font-medium mb-0.5">No transcripts yet</p>
            <p className="text-th-tx2 text-xs leading-relaxed">
