...
const PLATFORMS = [
  {
    ...
    color: 'text-sky-400',
    bg: 'bg-sky-500/10 border-sky-500/20',
    content: 'New episode just dropped. ShowBrain transcribed it and wrote the full thread — hook, breakdown, and CTA. Posted in 30 seconds. 🧵',
    tag: 'Auto thread',
  },
  {
    icon: Send,
    ...
    content: 'ShowBrain read the transcript and wrote a LinkedIn post pulling out the sharpest insight from the episode — framed for a professional audience, ready to publish.',
    tag: 'LinkedIn post',
  },
  {
    icon: MessageCircle,
    ...
    color: 'text-pink-400',
    bg: 'bg-pink-500/10 border-pink-500/20',
    content: 'ShowBrain turned the episode into an Instagram caption with a hook, key takeaway, and hashtags — optimised for reach, written in your voice.',
  ...
  },
  {
    ...
    color: 'text-amber-400',
    bg: 'bg-amber-500/10 border-amber-500/20',
    content: 'ShowBrain wrote the newsletter blurb — a short, compelling summary of the episode that gives subscribers a reason to click play without spoiling the best bits.',
    tag: 'Email blurb',
  },
];
