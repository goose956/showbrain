  ...
  return (
    <div className="flex flex-col h-full overflow-auto">
      <div className="border-b border-th-border px-6 py-4 shrink-0">
        ...
        {!hasEnoughData && (
          <div className="mt-3 flex items-start gap-2 text-xs border rounded-lg p-3" style={{background:'rgb(254 243 199/0.4)', borderColor:'rgb(217 119 6/0.4)'}}>
            <AlertCircle size={13} className="shrink-0 mt-0.5 text-th-tx2" />
            <span className="text-th-tx2">Analyse at least 3 episodes on the Intelligence page first — the AI needs dimension data to make good recommendations.</span>
          </div>
        )}
      </div>
